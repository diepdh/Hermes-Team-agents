...
def test_verify_artifact_dispatches_to_correct_checker():
    assert CHECKER_REGISTRY.keys() == {"lit_review_md", "course_outline", "lecture_draft", "quiz_bank", "source_analysis", "literature_support", "paper_draft", "debate_verdict", "final_paper"}
